...
public class Controller implements Initializable {
    ...
    public void hiirPeal(MouseEvent mouseEvent) throws IOException {
            ...
            if (menüüonTühi && kogusonTühi) {
                ...
                for (int i = 0; i < joogid.getItems().size(); i++) {
                    if (ost.equals(joogid.getItems().get(i))) {
                        ...
                        screen.setText(String.valueOf(a.set(i, (Double.parseDouble(String.valueOf(a.get(i))) * Integer.parseInt(kogus.getText())))));
            ...
            if (ost.equals("")) {
                ...
                for (int i = 0; i < joogid.getItems().size(); i++) {
                    if (ost.contentEquals((CharSequence) joogid.getItems().get(i))) {
                        ...
                        //screen.setText(a.get());
                        screen.setText("Ostetud õlle maksab " + String.valueOf(a.set(i, (Double.parseDouble(String.valueOf(a.get(i))) * Integer.parseInt(kogus.getText())))) + " eurot.");
